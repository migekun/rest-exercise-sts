...
public class Casa {
	...
	private Persona propietariCasa;
	...
	public Persona getPropietariCasa() {
		return propietariCasa;
	}

	public void setPropietariCasa(Persona propietariCasa) {
		this.propietariCasa = propietariCasa;
	}
